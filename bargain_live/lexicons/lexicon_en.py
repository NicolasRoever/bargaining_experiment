class Lexicon:
    ...
    buyer_value_one_sided = "The buyer's value for the object is private and will be randomly set between 0 and 30 euros. Only the buyer knows their value, and this value will remain unknown to the seller."
    buyer_value_two_sided = "The buyer's value for the object is private and will be randomly set between 0 and 60 euros. Only the buyer knows their value, and this value will remain unknown to the seller."
