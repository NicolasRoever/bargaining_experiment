class Lexicon:
    ...
    negotiation_costs2 = " Cent an. Je länger die Verhandlung dauert, desto höher sind die Kosten für beide Teilnehmenden. Die Grafik auf der linken Seite zeigt die gesamten Verhandlungskosten. Die Summe der Verhandlungskosten wird von Ihrer Teilnahmevergütung abgezogen (die später noch erklärt wird)."
    ...
    comprehension_question_1_choice_3 = "In den einzelnen Runden wechseln sich die Rollen von Käufer und Verkäufer ab."
    ...
    intro_practice_rounds_2 = "und diese Rolle bleibt während des gesamten Experiments gleich. Bevor das Experiment beginnt, werden Sie drei Übungsrunde durchführen. Der Hauptzweck dieser Übungsrunde ist es, Sie mit der Umgebung vertraut zu machen. Keine Übungsrunde wird zu Ihrer endgültigen Auszahlung beitragen. Bitte lesen Sie die Anweisungen für jede Übungsrunde sorgfältig durch."
    ...
    bargain_page_payoffs_seller_payoff = "Verkäufer: Akzeptiertes Angebot - Verhandlungskosten"
    bargain_page_payoffs_buyer_payoff = "Käufer: Wert des Objekts - Akzeptiertes Angebot - Verhandlungskosten"

    bargain_page_payoffs_heading_2 = "Wenn der Käufer oder der Verkäufer die Verhandlung beendet:"
    bargain_page_payoffs_both_payoff = "Beide: - Verhandlungskosten"
