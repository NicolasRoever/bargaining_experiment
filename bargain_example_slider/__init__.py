...
class C(BaseConstants):
    NAME_IN_URL = 'live_bargaining_orig'
...
class Group(BaseGroup):
    ...
    latest_offer_by = models.IntegerField(initial=None)
...
class Bargain(Page):
    ...
    def live_method(player: Player, data):
        ...
        #player.amount_proposed = data
        #print(player.amount_proposed)
        ...
        if 'amount' in data:
            ...
            if data['type'] == 'propose':
                #if player.id_in_group != group.latest_offer_by:
                player.amount_proposed = amount
                group.latest_offer_by = player.id_in_group
